...
const I18N = {
  ...
  el: {
    ...
    geoTitle:     'Η τοποθεσία μου',
    geoSearching: 'Εντοπισμός θέσης…',
    geoDenied:    'Δεν δόθηκε άδεια τοποθεσίας.',
    geoFailed:    'Δεν βρέθηκε η θέση σου. Δοκίμασε ξανά ή γράψε διεύθυνση.',
    geoVague:     'Η θέση σου δεν είναι αρκετά ακριβής. Γράψε διεύθυνση.',
    geoHere:      'Η τοποθεσία μου',
  ...
  en: {
    ...
    geoTitle:     'My location',
    geoSearching: 'Finding your location…',
    geoDenied:    'Location permission was denied.',
    geoFailed:    'Could not find your location. Try again or type an address.',
    geoVague:     'Your location is not accurate enough. Type an address instead.',
    geoHere:      'My location',
